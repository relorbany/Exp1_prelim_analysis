...
out=/project2/gilad/reem/singlecellCM/round1/lowpass/CD3/CD3col3/demux/CD3col3_demux_whitelist
$demuxlet --sam $sam --tag-group CB --tag-UMI UB --vcf $vcf --field GT  --out $out --geno-error 0.01 --group-list /project2/gilad/reem/singlecellCM/round1/lowpass/CD3/CD3col3/data/cell_stats/whitelist.txt
