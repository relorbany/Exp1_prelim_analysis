...
out=/project2/gilad/reem/singlecellCM/round1/lowpass/CD3/CD3col3/demux/CD3col3_demux_alpha3
$demuxlet --sam $sam --tag-group CB --tag-UMI UB --vcf $vcf --field GT  --out $out --geno-error 0.01 --alpha 0 --alpha 0.3
